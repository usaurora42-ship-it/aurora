...
class ModelClientPhone(db.Model):
    ...
    client = db.relationship(
        'ModelClient',
        backref=db.backref('client_phone', lazy=True)
    )

    phone = db.relationship(
        'ModelPhone',
        backref=db.backref('phone_client', lazy=True)
    )

    errors = None

    # Create Client Phone
    def create_client_phone(self, data):
        v = ModelValidator()
